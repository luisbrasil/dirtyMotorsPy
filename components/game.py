...
class Game:
    ...
    def run(self):
        ...
        playerCar = Car(100, 100, AssetsPort.BLACK_CAR, ControlType.PLAYER1, WIDTH, HEIGHT)
        playerCar2 = Car(100, 100, AssetsPort.GREEN_CAR, ControlType.PLAYER2, WIDTH, HEIGHT)
